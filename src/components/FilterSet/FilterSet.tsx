...
export function FilterSet() {
  ...
  return (
    <div className={styles.filters}>
      ...
      <div className={`${styles[filters__section]} ${styles[filters__users]}`}>
      ...
      <div className={`${styles[filters__section]} ${styles[filters__age]}`}>

        <h4 className={styles.filters__section__title">Age Groups</h}>
